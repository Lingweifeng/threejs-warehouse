...
export default function(zone) {
    ...
    for(let i = 0; i <= zShelves.rowNum;  i++) {
        let rowY = zShelves.y + zShelves.height*i;
        // 生成每一格
        for(let j = 0; j < zShelves.columnNum; j++) {
            ...
            // 水平支架
            let trestleGeoV = new THREE.BoxBufferGeometry(thickness, thickness, zShelves.depth);
            // 右v
            ...
            shelves.add(mesh);
            // 中x1
            let trestleGeoH = new THREE.BoxBufferGeometry(zShelves.width, thickness, thickness);
    ...
    let flagGeo = new THREE.BoxBufferGeometry(1.2, 0.8, 0.01);
